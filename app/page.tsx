...
export default async function Dashboard(){
 ...
 return <div className="content"><div className="page-head"><div><div className="eyebrow">Visão executiva</div><h1>O que precisa andar agora.</h1><p>Produção, aprovação e distribuição sem planilha paralela.</p></div><Link className="button" href="/gerador-ideias">Gerador</Link></div>
